...
abstract class ShopifyResource
{
	...
	public function getH($urlParams = array(), $url = null, $dataKey = null)
    {
    ...
    public function get($urlParams = array(), $url = null, $dataKey = null)
    {
        ...
        return $this->processResponse($response['body'] , $dataKey);
    ...
    public function post($dataArray, $url = null, $wrapData = true)
    {
        ...
        return $this->processResponse($response['body'] , $this->resourceKey);
    }
